...
# returns first occurence in match
match = re.search(pattern, text)
print(match)

# Gives every occurence match 
matches = re.finditer(pattern,text)
for match in matches:
    print(match)
    print(match.spam())  #gives match location
    print(text[match.span()[0]:match.span()[1]]) #gives match location for 1st and 2nd 